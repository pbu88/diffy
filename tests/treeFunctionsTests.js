...
exports.testInsertFile = function(test) {
    ...
    test.equals('test.txt', tree.files[0], 'file names must be equals to test.txt');
    test.done();
};
...
exports.testInsertDir = function(test) {
    ...
    test.equal('test.txt', tree.dirs[0].files[0], 'file names must be equals to test.txt');
    test.done();
};
